defmodule Ecrits.Path do
  ...
  @doc """
  Resolve a path inside `.ecrits`.
  """
  # [deprecated] dead code — no callers in lib or test at either arity (dead-code audit 2026-07-13)
