defmodule ContractWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ContractWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ContractWeb.Gettext, "errors", msg, opts)
    end
  end
