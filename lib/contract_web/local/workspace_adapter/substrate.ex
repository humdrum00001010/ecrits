defmodule ContractWeb.Local.WorkspaceAdapter.Substrate do
  @moduledoc """
  ...
  @workspace Contract.Local.Workspace
  ...
  defp missing_api_message do
    "Local workspace substrate unavailable: expected Contract.Local.Workspace.new/1 and Contract.Local.Workspace.list/2."
  end
end
