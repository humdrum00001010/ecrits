defmodule Ecrits.Local.DocumentTest do
  ...
  defp ensure_local_runtime_started do
    ...
    if is_nil(Process.whereis(Ecrits.Local.Document.Registry)) do
      start_supervised!({Registry, keys: :unique, name: Ecrits.Local.Document.Registry})
    end
